...
public class TestCase1 {
	...
	public void womenCoatAndJackets() throws InterruptedException
	{
		...
		List<WebElement> allDiscountedPrice = driver.findElementsByXPath("//ul[@class='results-base']//div[@class='product-price']");
		System.out.println("Price of the first item displayed is: "+allDiscountedPrice.get(0).getText());
		Thread.sleep(2000);
